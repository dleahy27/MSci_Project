...
if __name__ == '__main__':
    ...
    an_d2x, an_d2y = np.loadtxt("/mnt/c/Users/dillo/Desktop/work/Uni/Year_5/Project/Code/MSci_Project/C++/outputs/an_boundary_derivs.csv", dtype='float', delimiter=',', unpack=True, skiprows=1, usecols=[4,5])
    ...
    axs[0].set_ylabel(r"$\partial^2_x z(x,y)$",fontsize=axes_size)
    axs[0].label_outer()
    ...
    axs[2].set_ylabel(r"$\partial^2_x z(x,y)$",fontsize=axes_size)
    ...
    axs[1].set_ylabel(r"$\partial^2_y z(x,y)$",fontsize=axes_size)
    ...
    axs[3].set_ylabel(r"$\partial^2_y z(x,y)$",fontsize=axes_size)
